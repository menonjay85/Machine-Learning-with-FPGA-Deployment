...
def grad_descent_gold(func, winital, alpha, total_iterations, tol):
    ...
    while ((i < total_iterations) and (w_update_mag > tol)):
        ...
        f_alpha = lambda alpha: func(w - alpha * Dg)
        optim_alpha = golden(f_alpha, w, Dg, alpha)
...
grad_descent_gold(f, w_init, alpha, tot_iter, tol)
